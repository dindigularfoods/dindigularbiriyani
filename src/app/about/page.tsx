...
const AboutPage = () => {
    ...
    return (
        <main className="relative min-h-screen bg-brand-ivory selection:bg-brand-gold selection:text-brand-burgundy">
            ...
            <section className="py-32 bg-gradient-to-b from-brand-ivory to-brand-gold/5 text-center border-t border-brand-gold/20">
                <div className="container mx-auto px-8">
                    <motion.div
                        initial={{ opacity: 0, scale: 0.95 }}
                        whileInView={{ opacity: 1, scale: 1 }}
                        className="max-w-3xl mx-auto p-12 gold-border bg-brand-ivory/60 backdrop-blur-sm"
                    >
                        <h3 className="font-display text-4xl md:text-5xl font-bold mb-8">
                            Join the <span className="text-brand-gold italic">Legacy</span>
                        </h3>
                        <p className="font-serif text-xl text-brand-burgundy bold italic max-w-2xl mx-auto">
                        ...
                        <button
                            ...
                            className="group flex items-center gap-4 mx-auto px-12 py-5 bg-brand-burgundy text-brand-ivory text-sm font-bold uppercase tracking-[0.4em] hover:bg-brand-gold hover:text-brand-burgundy transition-all duration-500 interactive"
                        >
                            Enquire Now
